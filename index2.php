...
<div style="position: fixed; z-index: -99; width: 100%; height: 100%">
	<?php $videolink = '4wTLjEqj5Xk'; ?> <!-- Note: This is the youtube video id. Change it here so that the iframe points to the right address. -->
...
<div class="col-xs-12" style="position:absolute;top:5px;left:0;position:absolute;overflow:hidden!important;">
	...
	<div class="col-xs-4 infobox">
		<table style="width:100%;" class="reg">
			...
			<tr><td class="text-white text-center"><i class="fa fa-university"></i></td><td>Bothering Builders</td></tr>
	...
	<div class="col-xs-4">
		<div class="col-xs-12 infobox">
			<table style="width:100%;" class="reg">
				...
				<tr><td class="text-white text-center"><img style="width:15px!important;height:15px!important;" src="http://fc02.deviantart.net/fs70/f/2014/341/1/2/simple_crown_bullet_by_slush_bee-d892v68.png"</td><td>Xonos</td><td>Owner</td></tr>
				<tr><td class="text-white text-center"><img style="width:15px!important;height:15px!important;" src="https://forums.alliedmods.net/images/smilies/bee.png"></img></td><td>Cookie Beast</td><td>Block Muncher</td></tr>
